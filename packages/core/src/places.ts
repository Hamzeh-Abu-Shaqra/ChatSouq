...
const PLACE_HINTS: Record<string, string[]> = {
  ...
  manicure: ["Salon", "Spa"],
  pedicure: ["Salon", "Spa"],
  // Multi-word grooming service patterns — "cut my hair", "trim my beard", etc.
  "cut hair": ["Salon"],
  "cut my hair": ["Salon"],
  "trim hair": ["Salon"],
  "trim my hair": ["Salon"],
  ...
  // ── Car Services & Repair ─────────────────────────────────────────────────
  mechanic:         ["Car Repair", "Auto Repair"],
  "auto repair":    ["Car Repair", "Auto Repair"],
  "car repair":     ["Car Repair"],
  "car service":    ["Car Repair", "Car Service"],
  "car maintenance":["Car Repair", "Car Service"],
  "car wash":       ["Car Wash"],
  "car washing":    ["Car Wash"],
  "oil change":     ["Car Repair", "Car Service"],
  "tyre change":    ["Car Repair"],
  "tire change":    ["Car Repair"],
  "tyre shop":      ["Car Repair"],
  "tire shop":      ["Car Repair"],
  "wheel alignment":["Car Repair"],
  "car detailing":  ["Car Wash", "Car Service"],
  "car parts":      ["Auto Parts"],
  "spare parts":    ["Auto Parts"],
  "auto parts":     ["Auto Parts"],
  "towing":         ["Car Repair"],
  "ورشة":           ["Car Repair", "Auto Repair"],
  "ميكانيكي":       ["Car Repair"],
  "صيانة سيارة":    ["Car Repair", "Car Service"],
  "غسيل سيارة":     ["Car Wash"],
  "غسيل سيارات":    ["Car Wash"],
  "كار ووش":        ["Car Wash"],
  "قطع غيار":       ["Auto Parts"],
  "تغيير زيت":      ["Car Repair", "Car Service"],
  "إطارات":         ["Car Repair"],
  "كفرات":          ["Car Repair"],

  // ── Clothing & Fashion ────────────────────────────────────────────────────
  clothing:         ["Clothing", "Boutique"],
  clothes:          ["Clothing", "Boutique"],
  boutique:         ["Boutique", "Clothing"],
  fashion:          ["Clothing", "Boutique"],
  outfit:           ["Clothing", "Boutique"],
  apparel:          ["Clothing"],
  "clothing store": ["Clothing"],
  "clothes shop":   ["Clothing", "Boutique"],
  "fashion store":  ["Boutique", "Clothing"],
  "ملابس":          ["Clothing", "Boutique"],
  "بوتيك":          ["Boutique", "Clothing"],
  "محل ملابس":      ["Clothing", "Boutique"],
  "أزياء":          ["Clothing", "Boutique"],

  // ── Shoes ─────────────────────────────────────────────────────────────────
  shoes:            ["Shoes", "Footwear"],
  "shoe store":     ["Shoes", "Footwear"],
  "shoe shop":      ["Shoes", "Footwear"],
  sneakers:         ["Shoes", "Footwear"],
  footwear:         ["Shoes", "Footwear"],
  "shoe repair":    ["Shoe Repair"],
  cobbler:          ["Shoe Repair"],
  "أحذية":          ["Shoes", "Footwear"],
  "محل أحذية":      ["Shoes", "Footwear"],
  ...
  // ── Sports Facilities ─────────────────────────────────────────────────────
  "swimming pool":  ["Swimming Pool", "Sports Center"],
  "swim":           ["Swimming Pool", "Sports Center"],
  "swimming":       ["Swimming Pool", "Sports Center"],
  "حمام سباحة":     ["Swimming Pool"],
  "مسبح":           ["Swimming Pool", "Sports Center"],
  "بيسين":          ["Swimming Pool"],
  football:         ["Sports Center", "Stadium"],
  futsal:           ["Sports Center"],
  basketball:       ["Sports Center"],
  tennis:           ["Sports Center", "Tennis Court"],
  padel:            ["Sports Center", "Padel Court"],
  squash:           ["Sports Center"],
  volleyball:       ["Sports Center"],
  "tennis court":   ["Tennis Court", "Sports Center"],
  "padel court":    ["Padel Court", "Sports Center"],
  "sports club":    ["Sports Center", "Gym"],
  "fitness center": ["Gym", "Sports Center"],
  "fitness club":   ["Gym", "Sports Center"],
  "ملعب":           ["Sports Center", "Stadium"],
  "ملاعب":          ["Sports Center", "Stadium"],
  "ملعب كرة قدم":   ["Sports Center", "Stadium"],
  "بادل":           ["Padel Court", "Sports Center"],
  "تنس":            ["Tennis Court", "Sports Center"],

  // ── Medical Specialists ───────────────────────────────────────────────────
  physiotherapy:    ["Physiotherapy", "Clinic"],
  physio:           ["Physiotherapy", "Clinic"],
  "physical therapy": ["Physiotherapy", "Clinic"],
  "blood test":     ["Medical Lab", "Clinic"],
  "blood work":     ["Medical Lab"],
  "medical test":   ["Medical Lab", "Clinic"],
  "medical lab":    ["Medical Lab"],
  laboratory:       ["Medical Lab"],
  pediatrician:     ["Clinic", "Hospital"],
  psychologist:     ["Clinic", "Mental Health"],
  psychiatrist:     ["Clinic", "Mental Health"],
  therapist:        ["Clinic", "Mental Health"],
  "mental health":  ["Clinic", "Mental Health"],
  specialist:       ["Clinic", "Hospital"],
  "see a doctor":   ["Clinic", "Doctor"],
  "book a doctor":  ["Clinic", "Doctor"],
  "علاج طبيعي":     ["Physiotherapy", "Clinic"],
  "مختبر":          ["Medical Lab"],
  "مختبر طبي":      ["Medical Lab"],
  "تحليل دم":       ["Medical Lab"],
  "فحص طبي":        ["Medical Lab", "Clinic"],
  "طبيب أطفال":     ["Clinic", "Hospital"],
  "طبيب نفسي":      ["Clinic", "Mental Health"],

  // ── Education Services ────────────────────────────────────────────────────
  "language school":  ["Language School", "School"],
  "language course":  ["Language School"],
  "language center":  ["Language School"],
  "learn arabic":     ["Language School"],
  "learn english":    ["Language School"],
  "english course":   ["Language School"],
  "arabic course":    ["Language School"],
  tutoring:           ["Tutoring", "School"],
  tutor:              ["Tutoring"],
  "driving school":   ["Driving School"],
  "driving lesson":   ["Driving School"],
  "learn to drive":   ["Driving School"],
  "مركز لغات":        ["Language School"],
  "مدرسة لغات":       ["Language School"],
  "تعلم الإنجليزية":  ["Language School"],
  "دروس خصوصية":      ["Tutoring", "School"],
  "مدرسة قيادة":      ["Driving School"],
  "تعليم قيادة":      ["Driving School"],

  // ── Entertainment Extensions ──────────────────────────────────────────────
  "watch a movie":   ["Cinema", "Movie Theater"],
  "watch a film":    ["Cinema", "Movie Theater"],
  "see a movie":     ["Cinema", "Movie Theater"],
  "go to the cinema":["Cinema", "Movie Theater"],
  film:              ["Cinema", "Movie Theater"],
  bowling:           ["Bowling"],
  "go bowling":      ["Bowling"],
  "bowling alley":   ["Bowling"],
  karting:           ["Karting", "Entertainment"],
  "go-kart":         ["Karting", "Entertainment"],
  "go kart":         ["Karting", "Entertainment"],
  "go karting":      ["Karting", "Entertainment"],
  "water park":      ["Water Park"],
  "aqua park":       ["Water Park"],
  "amusement park":  ["Amusement Park", "Theme Park"],
  "theme park":      ["Theme Park", "Amusement Park"],
  trampoline:        ["Trampoline Park", "Entertainment"],
  "escape room":     ["Entertainment"],
  "بولينج":          ["Bowling"],
  "بارك مائي":       ["Water Park"],
  "ملاهي":           ["Amusement Park", "Theme Park"],
  "ترامبولين":       ["Trampoline Park", "Entertainment"],

  // ── Pet Services ─────────────────────────────────────────────────────────
  "pet shop":        ["Pet Shop", "Veterinary"],
  "pet store":       ["Pet Shop"],
  "pet grooming":    ["Pet Grooming", "Veterinary"],
  "dog grooming":    ["Pet Grooming"],
  "cat grooming":    ["Pet Grooming"],
  "pet boarding":    ["Veterinary", "Pet Shop"],
  "محل حيوانات":     ["Pet Shop"],
  "عناية بالحيوانات":["Pet Grooming"],

  // ── Grooming Extensions ───────────────────────────────────────────────────
  threading:         ["Salon", "Spa"],
  "eyebrow threading":["Salon", "Spa"],
  facial:            ["Spa", "Salon", "Beauty Clinic"],
  "get a facial":    ["Spa", "Salon"],
  "skin treatment":  ["Spa", "Salon", "Beauty Clinic"],
  "laser hair":      ["Salon", "Beauty Clinic"],
  "laser removal":   ["Salon", "Beauty Clinic"],
  "teeth whitening": ["Dentist", "Clinic"],
  "nail salon":      ["Salon"],
  "nail art":        ["Salon"],
  "gel nails":       ["Salon"],
  "acrylic nails":   ["Salon"],
  "get my nails done":["Salon"],
  tattoo:            ["Tattoo Studio"],
  "tattoo studio":   ["Tattoo Studio"],
  "وشم":             ["Tattoo Studio"],
  "استوديو وشم":     ["Tattoo Studio"],
  "خيوط حواجب":      ["Salon", "Spa"],
  "تنظيف بشرة":      ["Spa", "Beauty Clinic"],
  "تبييض أسنان":     ["Dentist"],
  "رسم أظافر":       ["Salon"],
  sauna:             ["Spa", "Sauna"],
  ...
  // ── Food & Drink Consumption (place intent) ───────────────────────────────
  "eat out":         ["Restaurant", "Cafe"],
  "dine out":        ["Restaurant"],
  "grab a bite":     ["Restaurant", "Fast Food"],
  "grab food":       ["Restaurant", "Fast Food"],
  "book a table":    ["Restaurant", "Cafe"],
  "reserve a table": ["Restaurant"],
  reservation:       ["Restaurant", "Cafe"],
  "table for":       ["Restaurant"],
  "grab a coffee":   ["Cafe", "Coffee Shop"],
  "have a coffee":   ["Cafe", "Coffee Shop"],
  "get a coffee":    ["Cafe", "Coffee Shop"],
  "ice cream":       ["Dessert", "Ice Cream Shop"],
  "ice cream shop":  ["Ice Cream Shop", "Dessert"],
  gelato:            ["Ice Cream Shop", "Dessert"],
  "آيس كريم":        ["Ice Cream Shop", "Dessert"],
  "جيلاتو":          ["Ice Cream Shop", "Dessert"],

  // ── Fresh Produce ─────────────────────────────────────────────────────────
  greengrocer:       ["Greengrocer", "Market"],
  vegetables:        ["Greengrocer", "Market"],
  "fresh produce":   ["Greengrocer", "Market"],
  "fruit shop":      ["Greengrocer", "Market"],
  "خضار":            ["Greengrocer", "Market"],
  "خضروات":          ["Greengrocer", "Market"],
  "فواكه":           ["Greengrocer", "Market"],
  "بقالة خضار":      ["Greengrocer", "Market"],

  // ── Financial Services ────────────────────────────────────────────────────
  "money transfer":  ["Money Transfer", "Bank"],
  "western union":   ["Money Transfer"],
  "wire transfer":   ["Money Transfer", "Bank"],
  "exchange money":  ["Money Exchange", "Bank"],
  "currency exchange":["Money Exchange", "Bank"],
  "تحويل مبلغ":      ["Money Transfer"],
  "حوالة مالية":     ["Money Transfer"],
  "تحويل عملة":      ["Money Exchange"],
  "صرافة":           ["Money Exchange", "Bank"],
  ...
  "باص":             ["Bus Station"],
  "محطة باصات":      ["Bus Station"],
  "موقف باص":        ["Bus Station"],
  ...
  "معرض فني":        ["Gallery"],
  "استوديو تصوير":   ["Studio"],
  "دراسة رقص":       ["Dance Studio"],

  // ── Miscellaneous Services ────────────────────────────────────────────────
  "notary":          ["Notary", "Legal Services"],
  "كاتب عدل":        ["Notary"],
  "توثيق":           ["Notary"],
